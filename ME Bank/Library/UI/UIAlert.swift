...
@objc open class UIAlert : NSObject {
    ...
    fileprivate func topMostController() -> UIViewController? {
        ...
        if presentedVC == nil {
            print("UIAlert Error: You don't have any views set. You may be calling in viewdidload. Try viewdidappear.")
        }
        return presentedVC
    }
    ...
    @discardableResult
    open class func display(_ title: String, message: String, buttons:[String], buttonsPreferredStyle:[UIAlertAction.Style], tapBlock:((UIAlertAction,Int) -> Void)?) -> UIAlertController{
